<?php
 ...
 $turkish = array(
	...
	'poll:note_responses' => "Not: mevcut bir anketin seçim seçeneklerini değiştirerek (seçenekleri ekleme / silme veya varolan bir seçimin metnini değiştirme), tüm üyelerin yeni seçim kümesine dayalı olarak tekrar oy vermesine izin vermek için oylama için oyların sıfırlanmasıyla sonuçlanacaktır",
	...
	'poll:settings:notification_on_vote:title' => "Bir ankette yapılan oylamayla ilgili bir anketi yaratıcıya bildirilsinmi mi?",
	...
	'poll:settings:group_access:title' => "Grup anketleri etkinleştirilirse kim anketler hazırlar?",
	...
	'poll:settings:front_page:title' => "Yöneticiler, sitenin \ Günün anketi \ nin tek seferde tek bir anket yapabilir ?",
	'poll:settings:front_page:desc' => "(İlgili widget'i dizin sayfasına eklemek için Widget Yöneticisi eklentisi gereklidir)",
	...
	'poll:settings:site_access:title' => "Site çapında anketler kimler yaratabilir?",
...
',
	...
	'poll:settings:vote_in_river:title' => "anket oylamaları aktivite akısında gösterilsinmi?",
